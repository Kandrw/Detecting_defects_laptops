...
if __name__ == "__main__":
    image_dir = "/home/neznayka08/PycharmProjects/hacaton1/data/"  # Папка с изображениями
    label_dir = "/home/neznayka08/PycharmProjects/hacaton1/data/labels/"  # Папка с лейблами
    output_dir = "/home/neznayka08/PycharmProjects/hacaton1/data/output/"  # Папка, где будут созданы train, valid, test
